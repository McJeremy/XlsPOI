...
public class BigMoney
{
    ...
    public static Double add(Double b1, Double b2) {
        ...
        DecimalFormat df = new DecimalFormat("#.00");
        df.setRoundingMode(RoundingMode.FLOOR);
        BigDecimal d1 = buildBigDecimal(b1);
        BigDecimal d2 = buildBigDecimal(b2);
    ...
    public static BigDecimal sub(double v1,double v2){
        BigDecimal b1 =buildBigDecimal(v1);
        BigDecimal b2 =buildBigDecimal(v2);
        DecimalFormat df = new DecimalFormat("#.00");
    ...
    public static BigDecimal round(double v,int scale){
        ...
        BigDecimal b = buildBigDecimal(v);
