...
# Usage Example  
```java
        //init a xls workbook and set the xls document name
        ...
        //init the first sheet's head columns 
        ...
        //init the first sheet's data rows
        ...
        //put the first sheet into the xls 
        xlsData.getSheets().add(sheet1);

        //init the second sheet ......
        ...
        //merge rows and columns in some sheet 
